...
def test_staff_remains_denied_broad_catalog_edit_while_owner_retains_it(owner_orders_api):
    ...
    staff = replace(principal("catalog.read", "availability.manage", "lunch_special.manage"), role="staff")
    client.app.dependency_overrides[csrf_principal] = lambda: staff
    broad_payload = {
    ...
    owner = principal("catalog.write", "catalog.publish", "availability.manage", "modifiers.manage", "lunch_special.manage")
