    ...
    <section className="page-section compact-section ordering-page">
      <div className="operations-panel">
        ...
        <form className="product-form" aria-busy={isSubmitting || isResending} onSubmit={submit}>
          ...
          <label><span>Password</span><input autoComplete={creating ? "new-password" : "current-password"} disabled={isSubmitting} minLength={creating ? 15 : 8} required type="password" value={form.password} onChange={(event) => setForm({ ...form, password: event.target.value })} /></label>
