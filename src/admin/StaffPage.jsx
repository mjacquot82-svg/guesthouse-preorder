...
export default function StaffPage() {
  ...
  const load = () => fetchStaffAccounts().then(setAccounts).catch((value) => setError(value.message));
  useEffect(load, []);
