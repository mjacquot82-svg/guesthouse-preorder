...
test("Owner Loyalty includes searchable real products, status, and audited adjustment",()=>{const page=readFileSync(new URL("../../src/admin/LoyaltyPage.jsx",import.meta.url),"utf8");assert.match(page,/Search loyalty products/);assert.match(page,/Earn stamp/);assert.match(page,/Reward eligible/);assert.match(page,/Program status/);assert.match(page,/Required reason/)});
